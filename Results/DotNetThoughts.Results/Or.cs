...
public static partial class Extensions
{
    ...
    public static Result<(T, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13)> OrResult<T, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(Result<T> a, Result<T2> b, Result<T3> c, Result<T4> d, Result<T5> e, Result<T6> f, Result<T7> g, Result<T8> h, Result<T9> i, Result<T10> j, Result<T11> k, Result<T12> l, Result<T13> m) => a.Or(b).Or(c).Or(d).Or(e).Or(f).Or(g).Or(h).Or(i).Or(j).Or(k).Or(l).Or(m);
    public static Result<(T, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14)> OrResult<T, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>(Result<T> a, Result<T2> b, Result<T3> c, Result<T4> d, Result<T5> e, Result<T6> f, Result<T7> g, Result<T8> h, Result<T9> i, Result<T10> j, Result<T11> k, Result<T12> l, Result<T13> m, Result<T14> n) => a.Or(b).Or(c).Or(d).Or(e).Or(f).Or(g).Or(h).Or(i).Or(j).Or(k).Or(l).Or(m).Or(n);
